...
каким может быть демо код.


1)функция с достаточно громоздким кодом и выводами результата в дом и лог.
подсвечивать результат рамкой (jquery).
либо выводить его в лог

2)строка - вычислить через eval, показать текст и результат
